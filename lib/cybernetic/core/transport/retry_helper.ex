defmodule Cybernetic.Core.Transport.RetryHelper do
  ...
  def with_retry(headers, payload, fun, opts \\ []) do
    ...
    cond do
      ...
      true ->
        ...
        case fun.() do
          :ok = result ->
            emit_success_telemetry(headers, System.monotonic_time(:nanosecond) - start_time, retries)
            result
  ...
  defp calculate_backoff(retries, base_ms) do
    ...
    max_delay = min(base_ms * :math.pow(2, retries), 60_000) # Cap at 60 seconds
