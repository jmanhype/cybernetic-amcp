defmodule Cybernetic.Edge.Gateway.GenerateController do
  ...
  defp validate_max_tokens(tokens) when is_integer(tokens) and tokens > 0 and tokens <= 8192, do: tokens
  ...
  defp determine_episode_kind(_), do: :code_gen  # Use code_gen as default since :general is not valid
