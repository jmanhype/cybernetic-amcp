defmodule Cybernetic.MCP.Tools.CodeAnalysisToolTest do
  ...
  describe "parameter validation" do
    ...
    test "validates generate parameters" do
      assert :ok = CodeAnalysisTool.validate_params("generate", %{
        "template" => "genserver",
    ...
    test "validates refactor parameters" do
      assert :ok = CodeAnalysisTool.validate_params("refactor", %{
        "code" => "def test, do: :ok",
    ...
    test "validates security_scan parameters" do
      assert :ok = CodeAnalysisTool.validate_params("security_scan", %{"code" => "def test, do: :ok"})
